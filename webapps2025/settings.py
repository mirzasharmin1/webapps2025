...
SECRET_KEY = 'django-insecure-g!acgsx$x1)qb@)r469*j*a%ripea7w2c++6q%w9p58d&)q_z9'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'payapp.context_processors.notification_processor',
            ],
        },
    },
]
...
INITIAL_BALANCE_GBP = 750.00  # Initial balance in GBP
